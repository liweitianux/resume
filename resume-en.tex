  ...
  \experience
    ...
    [\begin{itemize}
      ...
      \item Used the R programming language to perform Logistic regressions
        ...
        disease.
    \end{itemize}]%
    [R, Data cleaning, Regression analysis, Hypothesis testing]
...
\begin{entries}[|]
  ...
  \entry{\textbf{Chinese}}{%
    \begin{description}
      \item[Writing] --- Good
        (involved in writing Fund Applications, annual reports,
        as well as writing and revising sections for
        \enquote{The Chinese SKA Science White Book})
      \item[Speaking] --- Good
