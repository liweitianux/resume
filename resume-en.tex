...
and skilled in Python, Shell, and various command line tools with
...
\begin{competences}[10em]
  ...
  \comptence{Tools}{%
    Ansible; SSH, tmux, Git, make; Regular expression
  }
...
\begin{educations}
  \education%
    ...
    {Physics}%
    {Ph.D. (candidate; expected to graduate in the first half of 2019)}
...
%======================================================================
% Experience
\sectionTitle{Main Experience}{\faBriefcase}
%======================================================================
\begin{experiences}
  \experience
    [April 2018]%
    {May 2018}%
    {Intern (data engineer) @ Leadvisor Technology Inc. (startup company)}%
    [\begin{itemize}
      \item Search and scrape product information from Amazon web pages
        using Python.
      \item Deploy Airflow to periodically execute the data scraping tasks.
    \end{itemize}]%
    [Data mining, Web analysis, Python, Airflow]
...
%    [Data transmission, Data storage, Agile development, Python]
  ...
  \experience
    [March 2018]%
    {present}%
    {DragonFly BSD developer}%
    [\begin{itemize}
      \item Improve kernel networking tools.
      \item Update RC scripts and build system.
      \item Discuss and answer questions in mailing list and IRC channels.
    \end{itemize}]%
    [BSD, Open source, Programming, Networking]
...
%    [Feature extraction, Data reduction, PCA]
  ...
  \experience
    {present \newline April 2017}%
    {Use Ansible to manage a VPS running DragonFly BSD which serves
      personal email, authoritative DNS, website, CalDAV/CardDAV,
      Git, IRC, etc.}%
...
%        (write research reports and journal papers)
