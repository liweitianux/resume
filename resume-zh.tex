  ...
  \project
    ...
    {\begin{itemize}
      \item 使用 Python 开发低频射电天文模拟软件 \texttt{FG21sim}
            （开源在 \link{https://github.com/liweitianux/fg21sim}{GitHub}）
  ...
  \project
    ...
    {\begin{itemize}
      ...
      \item 编写并维护一套数据处理程序 \texttt{chandra-acis-analysis}
            （开源在 \link{https://github.com/liweitianux/chandra-acis-analysis}{GitHub}）
    \end{itemize}}%
...
\begin{entries}[|]
  \entry{\textbf{汉语}}{%
    \begin{description}
      \item[写作] 良好（参与撰写项目申请、年度总结、技术报告等；
        撰写与修订\enquote{中国 SKA 科学白皮书}章节）
      \item[表达] 良好（多次助教习题课与答疑；学术报告与讨论）
    \end{description}
  }
